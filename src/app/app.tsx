    ...
    return (
        <div id="main-body" className="main-body">
            <Card id="company-card" className="company-card">
                ...
                <Card.Body>
                    <Card.Text>
                        We are a software consulting company specializing in cutting-edge solutions for businesses in
                        the United Kingdom.
                    </Card.Text>
            ...
            <Card id="who-am-i-card" className="who-am-i-card">
                ...
                <Card.Body>
                    <Card.Text id="who-am-i-text">
                        ...
                        different backgrounds. I am passionate about using technology to improve people's lives and
                        enhance my skills in the process.
                    </Card.Text>
                </Card.Body>
            </Card>
        </div>
